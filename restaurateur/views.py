...
def view_orders(request):
    orders = Order.objects.all().annotate(total_cost=Sum(F('order_items__product_cost')*F('order_items__quantity'), output_field=DecimalField())).prefetch_related('order_items')
    order_items = []
    for order in orders:
